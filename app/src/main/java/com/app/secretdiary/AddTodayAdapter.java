...
public class AddTodayAdapter extends RecyclerView.Adapter<AddTodayAdapter.AddTodayViewHolder> {
    ArrayList<Users> list;
    Context context;
    String todaydate;
    ArrayList<Users> list1;
    Activity activity;
    int REQUEST_FOR_ACTIVITY_CODE;

    public AddTodayAdapter(ArrayList<Users> list, Context context, Activity activity) {
        this.list = list;
    ...
    @Override
    public void onBindViewHolder(@NonNull AddTodayAdapter.AddTodayViewHolder holder, int i) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("DailyNote").child(FirebaseAuth.getInstance().getUid()).child(todaydate)
                                    .child(data.getPostkey()).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void unused) {
                                            ...
                                            FirebaseDatabase.getInstance().getReference().child("AddedImage").child(FirebaseAuth.getInstance().getUid()).child(todaydate)
                                                    .child(data.getPostkey()).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                                                        @Override
                                                        public void onSuccess(Void unused) {
                                                        }
